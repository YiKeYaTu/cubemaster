...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combination_reducers = __webpack_require__(204);

	var _combination_reducers2 = _interopRequireDefault(_combination_reducers);

	var _combination = __webpack_require__(206);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combination_action = __webpack_require__(205);
	...
	function controlcontrolResWapper() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _combination_action.CONTROL_RES_WAPPER:
	            return !state;
	        default:
	            return state;
	    }
	...
	function runServerRes() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _combination_action.SEND_CONNECT:
	            return [action.json];
	        default:
	            return state;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CONTROL_RES_WAPPER = exports.SEND_CONNECT = exports.ADD_AJAX_DATA = exports.ADD_ACTIVE_INDEX = undefined;

	var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; };

	exports.controlResWapper = controlResWapper;
	...
	var CONTROL_RES_WAPPER = exports.CONTROL_RES_WAPPER = 'CONTROL_RES_WAPPER';

	function controlResWapper() {
	    return {
	...
	function fetchPosts() {
	    ...
	    return function (dispatch) {
	        ...
	        // return fetch('./', {
	        return (0, _isomorphicFetch2.default)(_urlConfig2.default.getDataServer, {
	            credentials: 'include',
	            mode: 'no-cors'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _res_content = __webpack_require__(219);

	var _res_content2 = _interopRequireDefault(_res_content);
	    ...
	    _createClass(AppComponent, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_Content2.default, this.props),
	                _react2.default.createElement(_res_content2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _data_item = __webpack_require__(208);

	var _data_item2 = _interopRequireDefault(_data_item);

	var _combination = __webpack_require__(209);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _delete = __webpack_require__(211);

	var _delete2 = _interopRequireDefault(_delete);

	var _more = __webpack_require__(212);

	var _more2 = _interopRequireDefault(_more);

	var _more_content = __webpack_require__(213);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CombinationStart = _react2.default.createClass({
	    ...
	    judRun: function judRun(data, model) {
	        return true;
	        console.log(data, model);
	        if (data.length === 0 || model.length === 0 || !model.slice(-1).output) {
	            return false;
	        } else {
	            return true;
	        }
	    ...
	    handleClick: function handleClick() {
	        ...
	        this.props.dispatch((0, _combination_action.controlResWapper)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResContent = _react2.default.createClass({
	    displayName: 'ResContent',
	    handleWapperClick: function handleWapperClick() {
	        this.props.dispatch((0, _combination_action.controlResWapper)());
	    },
	    render: function render() {
	        return _react2.default.createElement(ResContentComponent, _extends({}, this.props, {
	            handleWapperClick: this.handleWapperClick
	        }));
	    }
	});

	var ResContentComponent = function (_Component) {
	    _inherits(ResContentComponent, _Component);

	    function ResContentComponent() {
	        _classCallCheck(this, ResContentComponent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ResContentComponent).apply(this, arguments));
	    }

	    _createClass(ResContentComponent, [{
	        key: 'render',
	        value: function render() {
	            var _ref;
	                ...
	                _react2.default.createElement(
	                    'div',
	                    {
	                        ...
	                        style: (_ref = {
	                            ...
	                            background: 'rgb(84, 182, 231)',
	                            borderRadius: '20px'
	                        }, _defineProperty(_ref, 'position', 'relative'), _defineProperty(_ref, 'cursor', 'auto'), _defineProperty(_ref, 'left', '50%'), _defineProperty(_ref, 'top', '50%'), _defineProperty(_ref, 'overflowY', 'scroll'), _defineProperty(_ref, 'margin', '-175px -175px'), _ref)
	                    },
	                    _react2.default.createElement(ResContentShowListComponent, this.props),
	                    _react2.default.createElement(
	                        'div',
	                        {
	                            onClick: this.props.handleWapperClick,
	    ...
	    return ResContentComponent;
	}(_react.Component);

	var ResContentShowListComponent = function (_Component2) {
	    _inherits(ResContentShowListComponent, _Component2);

	    function ResContentShowListComponent() {
	        _classCallCheck(this, ResContentShowListComponent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ResContentShowListComponent).apply(this, arguments));
	    }

	    _createClass(ResContentShowListComponent, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'ul',
	                ...
	                _react2.default.createElement(ListNameComponent, this.props),
	                _react2.default.createElement(ListContentComponent, this.props)
	            );
	        }
	    }]);

	    return ResContentShowListComponent;
	}(_react.Component);

	var ListNameComponent = function (_Component3) {
	    _inherits(ListNameComponent, _Component3);

	    function ListNameComponent() {
	        _classCallCheck(this, ListNameComponent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ListNameComponent).apply(this, arguments));
	    }

	    _createClass(ListNameComponent, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'li',
	                ...
	                _react2.default.createElement(
	                    'p',
	                    {
	                        style: {
	                            ...
	                            height: '30px',
	                            lineHeight: '32px',
	                            background: 'url(' + __webpack_require__(220) + ') no-repeat 0px center',
	                ...
	                _react2.default.createElement(LisetComponent, _extends({}, this.props, {
	                    type: '0'
	                }))
	            );
	        }
	...
	var ListContentComponent = function (_Component4) {
	    _inherits(ListContentComponent, _Component4);

	    function ListContentComponent() {
	        _classCallCheck(this, ListContentComponent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ListContentComponent).apply(this, arguments));
	    }
	                ...
	                _react2.default.createElement(
	                    'p',
	                    {
	                        style: {
	                            ...
	                            height: '30px',
	                            lineHeight: '32px',
	                            background: 'url(' + __webpack_require__(221) + ') no-repeat 0px center',
	                            backgroundSize: '16px 16px'
	                        }
	                    },
	                    _react2.default.createElement(
	...
	var LisetComponent = function (_Component5) {
	    _inherits(LisetComponent, _Component5);

	    function LisetComponent() {
	        _classCallCheck(this, LisetComponent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LisetComponent).apply(this, arguments));
	    }

	    _createClass(LisetComponent, [{
	        key: 'render',
	        value: function render() {

	            var res = this.props.resContentList,
	                type = this.props.type;
	    ...
	    return LisetComponent;
	}(_react.Component);

	exports.default = ResContent;
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
